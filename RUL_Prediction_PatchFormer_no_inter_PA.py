...
for start_point in args.start_point_list:
    ...
    while count<args.count:
        ...
        # --------------------------------------step 2: 网络构建--------------------------------------------------------
        # ----------------------------------------- 创建基线模型 ----------------------------------------------
        from ModelsModify.PatchFormer_no_inter_PA import PatchFormer_no_inter_PANetModel
        model = PatchFormer_no_inter_PANetModel.from_dataset(
            training,
        ...
        best_model = PatchFormer_no_inter_PANetModel.load_from_checkpoint(best_model_path).to(device=device)
