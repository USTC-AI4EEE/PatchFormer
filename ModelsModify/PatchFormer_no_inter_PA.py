...
class PatchFormer_no_inter_PA(nn.Module):
    def __init__(self,patch_len,seq_len,pred_len,
        ...
        super(PatchFormer_no_inter_PA,self).__init__()
        ...
        # ##intra_patch_attention(CrossAttention)
...
class PatchFormer_no_inter_PANetModel(BaseModel):
    def __init__(self,patch_len,seq_len,pred_len,enc_in, 
        ...
        self.network = PatchFormer_no_inter_PA(
...
if __name__=='__main__':
    mymodel = PatchFormer_no_inter_PA(
            patch_len=2,
            enc_in=1,
            seq_len=32,
            pred_len=1)
